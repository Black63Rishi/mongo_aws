package com.example.MongoConnectAws.service;

import com.example.MongoConnectAws.config.JwtUtils;
import com.example.MongoConnectAws.model.ERole;
...
public class AuthService {
    ...
    public ResponseEntity<Users> update(String  id, String role) {
